...
const META = {
  ...
  line: {
    ...
    pattern: "Series as an open `line` polyline (last point must not return to the first, or it fills); axes and gridlines as thin `line` elements; SLA dashed threshold; vertical event marker.",
    routing: "Time left→right. Series may diagonal; axes and markers stay orthogonal.",
    avoid: "Exact data points without source; a trend with no scale or event — mood, not an argument.",
    budget: "1–2 series.",
  },
  scatter: {
    title: "Scatter plot",
