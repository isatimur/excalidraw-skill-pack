...
const META = {
  ...
  "it-state": {
    ...
    pattern: "Fan ≥3 sources into the bus on an orthogonal rail; fan ≥2 targets out; name the choke in a caption.",
    routing: "Shared vertical rails into/out of the ESB — no converging diagonals.",
    avoid: "Wallpaper of apps with no single finding; one lonely SaaS that understates the throat.",
    budget: "≤8 systems.",
  },
  "data-flow": {
    title: "Data flow",
  ...
  bar: {
    ...
    pattern: "Rectangles as bars; category labels below; gridlines as thin `line` elements; dashed avg line; prior-year grey stubs left of live bars so YoY is visible.",
    routing: "Even spacing; shared baseline.",
    avoid: "3D effects or gradient fills; bars with no scale; a YoY caption with no prior-year mark.",
    budget: "≤8 categories.",
  },
  line: {
    title: "Line chart",
