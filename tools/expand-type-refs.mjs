...
const META = {
  ...
  flowchart: {
    ...
    pattern: "Prefer skeleton: `ellipse` trigger, `diamond` decision, `rectangle` action. Free text for Yes/No beside the elbows.",
  ...
  sequence: {
    ...
    pattern: "Skeleton rectangles for lifelines. Free-floating text for message labels placed ABOVE the shaft — bound labels collide at Cascadia width.",
  ...
  nested: {
    ...
    pattern: "Dashed zone rectangles; leaf components as solid rectangles inside. Gateway as the edge of the platform.",
    routing: "Arrows only when crossing a boundary matters; free protocol labels above shafts.",
