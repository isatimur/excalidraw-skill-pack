...
def main() -> int:
    ...
    parser.add_argument("--theme", default="default-sketchy", help="Theme name (default: default-sketchy)")
    parser.add_argument("--output", "-o", type=Path, default=None, help="Output PNG path (default: input with .png)")
