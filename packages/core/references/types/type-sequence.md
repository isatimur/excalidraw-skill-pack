...
## Anti-patterns
Mixing architecture boxes with sequence timing; a four-message wallpaper with no miss/fail branch; no time axis; a 250ms budget with no hop times; a long miss path with no activation mark.
