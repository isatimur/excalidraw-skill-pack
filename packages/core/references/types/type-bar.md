...
## Excalidraw pattern
Rectangles as bars; category labels below; gridlines as thin `line` elements behind the bars.

## Connectors & routing
Even spacing; shared baseline.

## Anti-patterns
3D effects or gradient fills; bars with no scale, which rank the categories but never say by how much.
