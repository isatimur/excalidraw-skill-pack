...
## Anti-patterns
Exact data points without source; a trend with no scale or event — mood, not an argument; claiming a rewrite win without a prior-year control; an alert threshold that equals the SLA.
